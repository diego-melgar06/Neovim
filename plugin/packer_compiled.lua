...
_G.packer_plugins = {
  ...
  ["alternate-toggler"] = {
    loaded = true,
    path = "/home/diego/.local/share/nvim/site/pack/packer/start/alternate-toggler",
  ...
  ["eslint.nvim"] = {
    loaded = true,
    path = "/home/diego/.local/share/nvim/site/pack/packer/start/eslint.nvim",
  ...
  ["nvim-ts-autotag"] = {
    loaded = true,
    path = "/home/diego/.local/share/nvim/site/pack/packer/start/nvim-ts-autotag",
  ...
  ["onedark.nvim"] = {
    loaded = true,
    path = "/home/diego/.local/share/nvim/site/pack/packer/start/onedark.nvim",
  ...
  ["template-string.nvim"] = {
    loaded = true,
    path = "/home/diego/.local/share/nvim/site/pack/packer/start/template-string.nvim",
    url = "https://github.com/axelvc/template-string.nvim"
  },
  ["typescript.nvim"] = {
    loaded = true,
    path = "/home/diego/.local/share/nvim/site/pack/packer/start/typescript.nvim",
  ...
  ["wildfire.vim"] = {
    loaded = true,
    path = "/home/diego/.local/share/nvim/site/pack/packer/start/wildfire.vim",
